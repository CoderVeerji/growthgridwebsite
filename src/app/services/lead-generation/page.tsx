      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl">
        <Reveal>
          <h1 className="text-4xl md:text-6xl font-heading font-extrabold mb-6">
            Predictable <span className="text-primary">Lead Generation</span>
          </h1>
          <p className="text-xl text-muted mb-10 max-w-3xl">
            Stop relying on word-of-mouth or expensive directory platforms. We build lead generation engines that bring you exclusive, high-intent customers every single month.
          </p>
        </Reveal>

        <Reveal delay={0.2}>
          <div className="glass p-8 rounded-2xl mb-12 border border-card-border">
            <h2 className="text-2xl font-bold mb-6">Our Lead Gen System</h2>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                "Targeted Google Ads & Meta Ads",
        ...
        <Reveal delay={0.3}>
          <div className="text-center mt-12">
            <Link href="/contact" className="inline-flex items-center justify-center gap-2 bg-primary hover:bg-accent text-white px-8 py-4 rounded-full font-bold transition-all text-lg shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.6)]">
              Start Getting Leads <ArrowRight size={20} />
            </Link>
          </div>
        </Reveal>
      </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Professional lead generation services using paid advertising and sales funnels to acquire customers."
          })
        }}
      />
    </div>
